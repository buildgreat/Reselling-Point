...
if($_SESSION['flag']==1)
{
    ...
    $bookname = $_SESSION['sub'];
    $pub_name = $_SESSION['pname'];
...
<div class="container" style="font-family: “Times New Roman”, Times, serif; font-size: 20px; color: chocolate;">
    <table style="width:100%; border: 1px solid black;border-collapse: collapse;background-color:cyan;">
  <tr>
    <th>Name</th>
    <th>Condition</th> 
    <th>Cost</th>
    ...
    <?php
    $sql3="Select * from bsell where bookname='$bookname' AND pub_name='$pub_name' AND semofbook='$sem' AND catofbook='$branch'";
    $result3 = mysqli_query($conn,$sql3);
    //echo 'done';
    //echo $result3;
    while ($values3 = mysqli_fetch_array($result3)) {
    ?>
  <tr>
    <td><?php echo $values3['name']; ?></td>
    <td><?php echo $values3['bcond']; ?></td> 
    <td><?php echo $values3['cost']; ?></td>
    <td><?php echo $values3['no1']; ?></td>
  </tr>
...
<?php
header("refresh:1;http://localhost/secondhand/homepage.php");     
}
 ?>
