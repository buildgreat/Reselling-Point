...
$l_pass = $_POST['l-pass'];
$result = mysqli_query($conn,"Select * from register where user_name = '$l_userid' order by id");
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <img style="height:500px;" src="p5.jpg" alt="Image">
        ...
        <div class="item" >
        <img style="height:500px;" src="p4.jpg" alt="Image">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img style="height:500px;" src="p2.jpg" alt="Image">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img style="height:500px;" src="p1.jpg" alt="Image">
        <div class="carousel-caption">
       ...
       <div class="item">
        <img style="height:500px;" src="p3.jpg" alt="Image">
        <div class="carousel-caption">
...
<div style="height:400px;">    <br>
    ...
    <div class="col-md-4">
      <img src="http://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:200px; height:300px;" alt="Image">
      <p><h4>VIDEO</h4></p>
    </div>
</div><br>
