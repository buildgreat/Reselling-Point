...
<div class="form-group">
      ...
      <div class="form-group">
      <label class="control-label col-sm-5" for="semister">Semister:</label>
      <div class="col-sm-3">
   ...
   <!--   <div class="form-group">
      ...
      <div class="col-sm-offset-2 col-md-3" style="color: chocolate">
          <input type="submit" class="btn btn-default" name="b1-submit" value="submit"></input>
      </div>
    </div>
  </form>
</div>
